...
-- Date        : Sat Sep 26 21:44:45 2020
-- Host        : NoorWindows running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim {c:/Users/nfaki/Desktop/ee 108/Lab
--               1/update_Lab1_project/update_Lab1_project.srcs/sources_1/ip/hdmi_tx_0/hdmi_tx_0_sim_netlist.vhdl}
-- Design      : hdmi_tx_0
...
architecture STRUCTURE of hdmi_tx_0_hdmi_tx_v1_0 is
  ...
  signal rst_q1 : STD_LOGIC;
  signal rst_q2 : STD_LOGIC;
...
rst_q1_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
rst_q1_reg: unisim.vcomponents.FDPE
     port map (
      C => pix_clk,
      CE => '1',
      D => '0',
...
rst_q2_reg: unisim.vcomponents.FDPE
     port map (
      C => pix_clk,
      CE => '1',
      D => rst_q1,
...
srldly_0: entity work.hdmi_tx_0_srldelay
     port map (
      data_i(26 downto 19) => pix_data(7 downto 0),
      data_i(18 downto 11) => pix_data(15 downto 8),
      data_i(10 downto 3) => pix_data(23 downto 16),
      data_i(2) => hsync,
      data_i(1) => vsync,
      data_i(0) => vde,
...
entity hdmi_tx_0 is
  ...
  attribute X_CORE_INFO of hdmi_tx_0 : entity is "hdmi_tx_v1_0,Vivado 2020.1";
end hdmi_tx_0;
...
architecture STRUCTURE of hdmi_tx_0 is
  ...
  attribute X_INTERFACE_PARAMETER of pix_clkx5 : signal is "XIL_INTERFACENAME pix_clkx5, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, INSERT_VIP 0";
